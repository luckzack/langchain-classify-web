...
def get_demo_data():
    ...
    if DEMO_TEXT_FILE.__contains__("xlsx"):
        df_texts = pd.read_excel(DEMO_TEXT_FILE)    
    elif DEMO_TEXT_FILE.__contains__("csv"):
        df_texts = pd.read_csv(DEMO_TEXT_FILE)    
    else:
        df_texts = pd.read_excel(DEMO_TEXT_FILE)   
    ...
    if DEMO_CATEGORY_FILE.__contains__("xlsx"):
        df_categories = pd.read_excel(DEMO_CATEGORY_FILE)    
    elif DEMO_CATEGORY_FILE.__contains__("csv"):
        df_categories = pd.read_csv(DEMO_CATEGORY_FILE)    
    else:
        df_categories = pd.read_excel(DEMO_CATEGORY_FILE)    
...
def get_settings():
    ...
    """
    settings = {}
    with st.sidebar.expander(lang["llm_settings"], expanded=True):
